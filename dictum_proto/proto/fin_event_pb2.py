...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'proto.fin_event_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z$github.com/AlexKenbo/dictum_proto/go'
  _FINEVENT.methods_by_name['ListSignatures']._options = None
  _FINEVENT.methods_by_name['ListSignatures']._serialized_options = b'\202\323\344\223\002$\022\"/v1/{parent=accruals/*}/signatures'
  _FINEVENT.methods_by_name['ListComments']._options = None
  _FINEVENT.methods_by_name['ListComments']._serialized_options = b'\202\323\344\223\002\"\022 /v1/{parent=accruals/*}/comments'
  _FINEVENT.methods_by_name['CreateComment']._options = None
  _FINEVENT.methods_by_name['CreateComment']._serialized_options = b'\202\323\344\223\002:\"//v1/{comment.resource_name=accruals/*}/comments:\007comment'
  _FINEVENT.methods_by_name['UpdateComment']._options = None
  _FINEVENT.methods_by_name['UpdateComment']._serialized_options = b'\202\323\344\223\00212&/v1/{comment.resource_name=comments/*}:\007comment'
  _FINEVENT.methods_by_name['DeleteComment']._options = None
  _FINEVENT.methods_by_name['DeleteComment']._serialized_options = b'\202\323\344\223\002 *\036/v1/{resource_name=comments/*}'
  _FINEVENT.methods_by_name['CreatePermission']._options = None
  _FINEVENT.methods_by_name['CreatePermission']._serialized_options = b'\202\323\344\223\002Y\"K/v1/{permission.resource_name=entities/*/employees/*/actions/*}/permissions:\npermission'
  _FINEVENT.methods_by_name['ListPermissions']._options = None
  _FINEVENT.methods_by_name['ListPermissions']._serialized_options = b'\202\323\344\223\002$\022\017/v1/permissionsZ\021\022\017/v1/permissions'
  _FINEVENT.methods_by_name['DeletePermission']._options = None
  _FINEVENT.methods_by_name['DeletePermission']._serialized_options = b'\202\323\344\223\0026*4/v1/{resource_name=entities/*/employees/*/actions/*}'
  _FINEVENT.methods_by_name['ListActions']._options = None
  _FINEVENT.methods_by_name['ListActions']._serialized_options = b'\202\323\344\223\002\034\022\013/v1/actionsZ\r\022\013/v1/actions'
  _FINEVENT.methods_by_name['ListTransfers']._options = None
  _FINEVENT.methods_by_name['ListTransfers']._serialized_options = b'\202\323\344\223\0024\022\r/v1/transfersZ#\022!/v1/{parent=accounts/*}/transfers'
  _FINEVENT.methods_by_name['GetTransfer']._options = None
  _FINEVENT.methods_by_name['GetTransfer']._serialized_options = b'\202\323\344\223\002!\022\037/v1/{resource_name=transfers/*}'
  _FINEVENT.methods_by_name['CreateTransfer']._options = None
  _FINEVENT.methods_by_name['CreateTransfer']._serialized_options = b'\202\323\344\223\002\031\"\r/v1/transfers:\010transfer'
  _FINEVENT.methods_by_name['AllocateTransfer']._options = None
  _FINEVENT.methods_by_name['AllocateTransfer']._serialized_options = b'\202\323\344\223\0024\"(/v1/{resource_name=transfers/*}/allocate:\010transfer'
  _FINEVENT.methods_by_name['BatchInsertTransfers']._options = None
  _FINEVENT.methods_by_name['BatchInsertTransfers']._serialized_options = b'\202\323\344\223\002&\"\023/v1/batch-transfers:\017batch_transfers'
  _FINEVENT.methods_by_name['UpdateTransfer']._options = None
  _FINEVENT.methods_by_name['UpdateTransfer']._serialized_options = b'\202\323\344\223\00242(/v1/{transfer.resource_name=transfers/*}:\010transfer'
  _FINEVENT.methods_by_name['AggregateTransfers']._options = None
  _FINEVENT.methods_by_name['AggregateTransfers']._serialized_options = b'\202\323\344\223\002\033\022\031/v1/transfers/-/aggregate'
  _FINEVENT.methods_by_name['ListAccruals']._options = None
  _FINEVENT.methods_by_name['ListAccruals']._serialized_options = b'\202\323\344\223\0024\022\014/v1/accrualsZ$\022\"/v1/{parent=operations/*}/accruals'
  _FINEVENT.methods_by_name['GetAccrual']._options = None
  _FINEVENT.methods_by_name['GetAccrual']._serialized_options = b'\202\323\344\223\002 \022\036/v1/{resource_name=accruals/*}'
  _FINEVENT.methods_by_name['CreateAccrual']._options = None
  _FINEVENT.methods_by_name['CreateAccrual']._serialized_options = b'\202\323\344\223\002\027\"\014/v1/accruals:\007accrual'
  _FINEVENT.methods_by_name['UpdateAccrual']._options = None
  _FINEVENT.methods_by_name['UpdateAccrual']._serialized_options = b'\202\323\344\223\00212&/v1/{accrual.resource_name=accruals/*}:\007accrual'
  _FINEVENT.methods_by_name['AggregateAccruals']._options = None
  _FINEVENT.methods_by_name['AggregateAccruals']._serialized_options = b'\202\323\344\223\002L\022\030/v1/accruals/-/aggregateZ0\022./v1/{parent=operations/*}/accruals/-/aggregate'
  _FINEVENT.methods_by_name['BatchInsertAccruals']._options = None
  _FINEVENT.methods_by_name['BatchInsertAccruals']._serialized_options = b'\202\323\344\223\002#\"\022/v1/batch-accruals:\rbatch_accrual'
  _FINEVENT.methods_by_name['GenerateAccrualPDF']._options = None
  _FINEVENT.methods_by_name['GenerateAccrualPDF']._serialized_options = b'\202\323\344\223\0025\0223/v1/{accrual.resource_name=accruals/*}/generate-pdf'
  _FINEVENT.methods_by_name['ListProducts']._options = None
  _FINEVENT.methods_by_name['ListProducts']._serialized_options = b'\202\323\344\223\0022\022\014/v1/productsZ\"\022 /v1/{parent=entities/*}/products'
  _FINEVENT.methods_by_name['ListPositions']._options = None
  _FINEVENT.methods_by_name['ListPositions']._serialized_options = b'\202\323\344\223\0022\022\r/v1/positionsZ!\022\037/v1/{parent=events/*}/positions'
  _FINEVENT.methods_by_name['UpdatePosition']._options = None
  _FINEVENT.methods_by_name['UpdatePosition']._serialized_options = b'\202\323\344\223\00242(/v1/{position.resource_name=positions/*}:\010position'
  _FINEVENT.methods_by_name['BatchInsertPostions']._options = None
  _FINEVENT.methods_by_name['BatchInsertPostions']._serialized_options = b'\202\323\344\223\002[\"\r/v1/positions:\017batch_positionsZ9\"&/v1/{resource_name=events/*}/positions:\017batch_positions'
  _FINEVENT.methods_by_name['ListArticles']._options = None
  _FINEVENT.methods_by_name['ListArticles']._serialized_options = b'\202\323\344\223\002\016\022\014/v1/articles'
  _FINEVENT.methods_by_name['GetArticle']._options = None
  _FINEVENT.methods_by_name['GetArticle']._serialized_options = b'\202\323\344\223\002 \022\036/v1/{resource_name=articles/*}'
  _FINEVENT.methods_by_name['CreateArticle']._options = None
  _FINEVENT.methods_by_name['CreateArticle']._serialized_options = b'\202\323\344\223\002\027\"\014/v1/articles:\007article'
  _FINEVENT.methods_by_name['UpdateArticle']._options = None
  _FINEVENT.methods_by_name['UpdateArticle']._serialized_options = b'\202\323\344\223\00212&/v1/{article.resource_name=articles/*}:\007article'
  _FINEVENT.methods_by_name['DeleteArticle']._options = None
  _FINEVENT.methods_by_name['DeleteArticle']._serialized_options = b'\202\323\344\223\002)*\036/v1/{resource_name=articles/*}:\007article'
  _FINEVENT.methods_by_name['ListAllocations']._options = None
  _FINEVENT.methods_by_name['ListAllocations']._serialized_options = b'\202\323\344\223\002`\022\017/v1/allocationsZ&\022$/v1/{parent=transfers/*}/allocationsZ%\022#/v1/{parent=accruals/*}/allocations'
  _FINEVENT.methods_by_name['CreateAllocation']._options = None
  _FINEVENT.methods_by_name['CreateAllocation']._serialized_options = b'\202\323\344\223\002\035\"\017/v1/allocations:\nallocation'
  _LISTPERMISSIONSRESPONSE._serialized_start=386
  _LISTPERMISSIONSRESPONSE._serialized_end=493
  _LISTSIGNATURESRESPONSE._serialized_start=495
  _LISTSIGNATURESRESPONSE._serialized_end=599
  _LISTCOMMENTSRESPONSE._serialized_start=601
  _LISTCOMMENTSRESPONSE._serialized_end=699
  _LISTACTIONSRESPONSE._serialized_start=701
  _LISTACTIONSRESPONSE._serialized_end=771
  _LISTARTICLESREQUEST._serialized_start=773
  _LISTARTICLESREQUEST._serialized_end=810
  _LISTTRANSFERSRESPONSE._serialized_start=812
  _LISTTRANSFERSRESPONSE._serialized_end=913
  _BATCHINSERTTRANSFERSREQUEST._serialized_start=915
  _BATCHINSERTTRANSFERSREQUEST._serialized_end=994
  _LISTACCRUALSRESPONSE._serialized_start=996
  _LISTACCRUALSRESPONSE._serialized_end=1094
  _BATCHINSERTACCRUALSREQUEST._serialized_start=1096
  _BATCHINSERTACCRUALSREQUEST._serialized_end=1172
  _BATCHINSERTPOSITIONSREQUEST._serialized_start=1174
  _BATCHINSERTPOSITIONSREQUEST._serialized_end=1256
  _ALLOCATETRANSFERREQUEST._serialized_start=1258
  _ALLOCATETRANSFERREQUEST._serialized_end=1306
  _LISTPRODUCTSRESPONSE._serialized_start=1308
  _LISTPRODUCTSRESPONSE._serialized_end=1406
  _LISTPOSITIONSRESPONSE._serialized_start=1408
  _LISTPOSITIONSRESPONSE._serialized_end=1509
  _LISTARTICLESRESPONSE._serialized_start=1511
  _LISTARTICLESRESPONSE._serialized_end=1584
  _LISTALLOCATIONSRESPONSE._serialized_start=1586
  _LISTALLOCATIONSRESPONSE._serialized_end=1693
  _FILERESPONSE._serialized_start=1695
  _FILERESPONSE._serialized_end=1723
  _FINEVENT._serialized_start=1726
  _FINEVENT._serialized_end=5299
