...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'proto.user_hub_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z$github.com/AlexKenbo/dictum_proto/go'
  _USERHUB.methods_by_name['ListUsers']._options = None
  _USERHUB.methods_by_name['ListUsers']._serialized_options = b'\202\323\344\223\002\013\022\t/v1/users'
  _USERHUB.methods_by_name['GetUser']._options = None
  _USERHUB.methods_by_name['GetUser']._serialized_options = b'\202\323\344\223\002\035\022\033/v1/{resource_name=users/*}'
  _USERHUB.methods_by_name['CreateUser']._options = None
  _USERHUB.methods_by_name['CreateUser']._serialized_options = b'\202\323\344\223\002\021\"\t/v1/users:\004user'
  _USERHUB.methods_by_name['UpdateUser']._options = None
  _USERHUB.methods_by_name['UpdateUser']._serialized_options = b'\202\323\344\223\002(2 /v1/{user.resource_name=users/*}:\004user'
  _USERHUB.methods_by_name['CreateUserProvider']._options = None
  _USERHUB.methods_by_name['CreateUserProvider']._serialized_options = b'\202\323\344\223\002:\"./v1/{provider.resource_name=users/*}/providers:\010provider'
  _LISTUSERSRESPONSE._serialized_start=121
  _LISTUSERSRESPONSE._serialized_end=210
  _USERHUB._serialized_start=213
  _USERHUB._serialized_end=603
