...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'proto.accounting_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z$github.com/AlexKenbo/dictum_proto/go'
  _ACCOUNTING.methods_by_name['ListAccountBalances']._options = None
  _ACCOUNTING.methods_by_name['ListAccountBalances']._serialized_options = b'\202\323\344\223\002\"\022 /v1/{parent=accounts/*}/balances'
  _ACCOUNTING.methods_by_name['GetAccountAudit']._options = None
  _ACCOUNTING.methods_by_name['GetAccountAudit']._serialized_options = b'\202\323\344\223\002 \022\036/v1/{parent=accounts/*}/audits'
  _ACCOUNTING.methods_by_name['GetAccountBalance']._options = None
  _ACCOUNTING.methods_by_name['GetAccountBalance']._serialized_options = b'\202\323\344\223\002(\022&/v1/{resource_name=accounts/*}/balance'
  _ACCOUNTING.methods_by_name['CreateAccountBalance']._options = None
  _ACCOUNTING.methods_by_name['CreateAccountBalance']._serialized_options = b'\202\323\344\223\002J\"7/v1/{account_balance.resource_name=accounts/*}/balances:\017account_balance'
  _ACCOUNTING.methods_by_name['ListAccrualStatusTransitions']._options = None
  _ACCOUNTING.methods_by_name['ListAccrualStatusTransitions']._serialized_options = b'\202\323\344\223\002 \022\036/v1/accrual-status-transitions'
  _ACCOUNTING.methods_by_name['ListTags']._options = None
  _ACCOUNTING.methods_by_name['ListTags']._serialized_options = b'\202\323\344\223\002*\022\010/v1/tagsZ\036\022\034/v1/{parent=entities/*}/tags'
  _ACCOUNTING.methods_by_name['CreateTag']._options = None
  _ACCOUNTING.methods_by_name['CreateTag']._serialized_options = b'\202\323\344\223\002?\"\010/v1/tags:\003tagZ.\"\'/v1/{tag.resource_name=entities/*}/tags:\003tag'
  _LISTACCRUALHISTORYREQUEST._serialized_start=168
  _LISTACCRUALHISTORYREQUEST._serialized_end=211
  _LISTTRANSFERHISTORYREQUEST._serialized_start=213
  _LISTTRANSFERHISTORYREQUEST._serialized_end=257
  _LISTTAGSREQUEST._serialized_start=259
  _LISTTAGSREQUEST._serialized_end=308
  _LISTACCOUNTBALANCESREQUEST._serialized_start=310
  _LISTACCOUNTBALANCESREQUEST._serialized_end=409
  _LISTACCOUNTAUDITSREQUEST._serialized_start=411
  _LISTACCOUNTAUDITSREQUEST._serialized_end=508
  _LISTACCRUALSTATUSTRANSITIONSREQUEST._serialized_start=510
  _LISTACCRUALSTATUSTRANSITIONSREQUEST._serialized_end=563
  _GETACCOUNTAUDITREQUEST._serialized_start=565
  _GETACCOUNTAUDITREQUEST._serialized_end=612
  _GETACCOUNTBALANCEREQUEST._serialized_start=614
  _GETACCOUNTBALANCEREQUEST._serialized_end=663
  _CREATEACCOUNTBALANCEREQUEST._serialized_start=665
  _CREATEACCOUNTBALANCEREQUEST._serialized_end=736
  _CREATEACCOUNTAUDITREQUEST._serialized_start=738
  _CREATEACCOUNTAUDITREQUEST._serialized_end=803
  _CREATETAGREQUEST._serialized_start=805
  _CREATETAGREQUEST._serialized_end=842
  _LISTACCOUNTBALANCESRESPONSE._serialized_start=844
  _LISTACCOUNTBALANCESRESPONSE._serialized_end=964
  _LISTTAGSRESPONSE._serialized_start=966
  _LISTTAGSRESPONSE._serialized_end=1027
  _LISTACCRUALSTATUSTRANSITIONSRESPONSE._serialized_start=1029
  _LISTACCRUALSTATUSTRANSITIONSRESPONSE._serialized_end=1152
  _ACCOUNTING._serialized_start=1155
  _ACCOUNTING._serialized_end=2015
