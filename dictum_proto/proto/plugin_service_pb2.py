...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'proto.plugin_service_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z$github.com/AlexKenbo/dictum_proto/go'
  _PLUGINSERVICE.methods_by_name['ListObjectSources']._options = None
  _PLUGINSERVICE.methods_by_name['ListObjectSources']._serialized_options = b'\202\323\344\223\002\241\001\022(/v1/{parent=agents/*/accruals/*}/sourcesZ0\022./v1/{parent=agents/*/counterparties/*}/sourcesZ-\022+/v1/{parent=accounts/*/transfers/*}/sourcesZ\024\022\022/v1/object-sources'
  _PLUGINSERVICE.methods_by_name['CreateObjectSource']._options = None
  _PLUGINSERVICE.methods_by_name['CreateObjectSource']._serialized_options = b'\202\323\344\223\002M\"\024/v1/accruals/sourcesZ\034\"\032/v1/counterparties/sourcesZ\027\"\025/v1/transfers/sources'
  _PLUGINSERVICE.methods_by_name['DeleteObjectSource']._options = None
  _PLUGINSERVICE.methods_by_name['DeleteObjectSource']._serialized_options = b'\202\323\344\223\0025*3/v1/{resource_name=services/*/accruals/*/sources/*}'
  _PLUGINSERVICE.methods_by_name['CreateService']._options = None
  _PLUGINSERVICE.methods_by_name['CreateService']._serialized_options = b'\202\323\344\223\002%\022#/v1/{resource_name=services/*}/runs'
  _PLUGINSERVICE.methods_by_name['ListServices']._options = None
  _PLUGINSERVICE.methods_by_name['ListServices']._serialized_options = b'\202\323\344\223\002\016\022\014/v1/services'
  _PLUGINSERVICE.methods_by_name['GetService']._options = None
  _PLUGINSERVICE.methods_by_name['GetService']._serialized_options = b'\202\323\344\223\002 \022\036/v1/{resource_name=services/*}'
  _PLUGINSERVICE.methods_by_name['UpdateService']._options = None
  _PLUGINSERVICE.methods_by_name['UpdateService']._serialized_options = b'\202\323\344\223\002 2\036/v1/{resource_name=services/*}'
  _PLUGINSERVICE.methods_by_name['CreateServiceRun']._options = None
  _PLUGINSERVICE.methods_by_name['CreateServiceRun']._serialized_options = b'\202\323\344\223\002%\"#/v1/{resource_name=services/*}/runs'
  _PLUGINSERVICE.methods_by_name['UpdateServiceRun']._options = None
  _PLUGINSERVICE.methods_by_name['UpdateServiceRun']._serialized_options = b'\202\323\344\223\002\'2%/v1/{resource_name=services/*/runs/*}'
  _PLUGINSERVICE.methods_by_name['GetServiceRun']._options = None
  _PLUGINSERVICE.methods_by_name['GetServiceRun']._serialized_options = b'\202\323\344\223\002\'\022%/v1/{resource_name=services/*/runs/*}'
  _PLUGINSERVICE.methods_by_name['ListServiceRuns']._options = None
  _PLUGINSERVICE.methods_by_name['ListServiceRuns']._serialized_options = b'\202\323\344\223\002>\022\034/v1/{parent=services/*}/runsZ\036\022\034/v1/{parent=services/-}/runs'
  _PLUGINSERVICE.methods_by_name['RunService']._options = None
  _PLUGINSERVICE.methods_by_name['RunService']._serialized_options = b'\202\323\344\223\002$\022\"/v1/{resource_name=services/*}:run'
  _GETLATESTSOURCEREQUEST._serialized_start=184
  _GETLATESTSOURCEREQUEST._serialized_end=247
  _LISTOBJECTSOURCESREQUEST._serialized_start=249
  _LISTOBJECTSOURCESREQUEST._serialized_end=307
  _LISTOBJECTSOURCESRESPONSE._serialized_start=309
  _LISTOBJECTSOURCESRESPONSE._serialized_end=390
  _GETSERVICEREQUEST._serialized_start=392
  _GETSERVICEREQUEST._serialized_end=433
  _LISTSERVICESREQUEST._serialized_start=435
  _LISTSERVICESREQUEST._serialized_end=472
  _LISTSERVICESRESPONSE._serialized_start=474
  _LISTSERVICESRESPONSE._serialized_end=546
  _GETSERVICERUNREQUEST._serialized_start=548
  _GETSERVICERUNREQUEST._serialized_end=592
  _LISTSERVICERUNSRESPONSE._serialized_start=594
  _LISTSERVICERUNSRESPONSE._serialized_end=702
  _RUNSERVICEREQUEST._serialized_start=704
  _RUNSERVICEREQUEST._serialized_end=745
  _PLUGINSERVICE._serialized_start=748
  _PLUGINSERVICE._serialized_end=2161
